...
const Files = createLucideIcon("files", __iconNode$c);
const __iconNode$b = [
...
const RotateCcwClock = createLucideIcon("rotate-ccw-clock", __iconNode$8);
const __iconNode$7 = [
...
const useWorkspaceStore = create((set, get) => ({
  ...
  initialize: async () => {
    set({ isLoading: true });
    try {
      const [notes, prompts, layout2] = await Promise.all([
        window.electron.invoke("get-notes"),
        window.electron.invoke("get-prompts"),
        window.electron.invoke("get-layouts")
      ]);
      set({ notes, prompts, workspaceLayout: layout2?.[0] || null, isLoading: false });
    } catch (err) {
  ...
  updateNote: async (noteId, title, content) => {
    const previousNotes = get().notes;
    const updatedNotes = previousNotes.map(
      (n) => n.id === noteId ? { ...n, title, content, updatedAt: Date.now() } : n
    );
  ...
  setWorkspaceLayout: async (layout2) => {
    const previousLayout = get().workspaceLayout;
    set({ workspaceLayout: layout2 });
    try {
      await window.electron.invoke("update-layout", layout2.id, layout2);
    } catch (err) {
...
function AIWorkspacePanel() {
  ...
  const [researching, setResearching] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    window.electron.invoke("agent:history").then((value) => setHistory(Array.isArray(value) ? value.slice(-8).reverse() : [])).catch(() => void 0);
  }, [isLoading]);
  reactExports.useEffect(() => window.electron.on("agent:event", (event) => {
  ...
  const run = async () => {
    ...
    setMessages((current) => [...current, { role: "user", content: goal }]);
    setInput("");
    setEvents([]);
    setSources([]);
    setCurrentSource(null);
    setResearching(/\bresearch\b/i.test(goal));
    setIsLoading(true);
    try {
      const result = await window.electron.invoke("agent:run", { goal });
      setRunId(result.runId || null);
    } catch (error) {
      setMessages((current) => [...current, { role: "assistant", content: error?.message || "Agent failed to start." }]);
      setIsLoading(false);
    }
  };
  const cancel = async () => {
    if (runId) await window.electron.invoke("agent:cancel", runId);
    else setIsLoading(false);
  };
  const icon = (type) => type === "tool-start" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Wrench, { size: 13 }) : type === "error" ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { size: 13 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 13 });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex flex-col h-full ${isDarkMode ? "bg-synapse-darker text-white" : "bg-white text-gray-900"}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `border-b ${isDarkMode ? "border-gray-700" : "border-gray-200"} p-4`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold", children: "AI Workspace" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500", children: "Agent mode: browser, research, workspace, and safe developer tools" }),
      history.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 text-xs text-gray-500", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold mb-1", children: "Previous runs" }),
        history.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between gap-2 truncate", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: item.goal }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: item.status === "completed" ? "text-green-500" : item.status === "cancelled" ? "text-yellow-500" : "text-red-400", children: item.status })
        ] }, item.runId))
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto p-4 space-y-3", children: [
      messages.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center text-gray-500 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Ask Synapse to research, inspect, create, or verify a task." }) }),
      messages.map((msg, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex ${msg.role === "user" ? "justify-end" : "justify-start"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `p-3 rounded-lg max-w-[85%] whitespace-pre-wrap ${msg.role === "user" ? "bg-synapse-accent text-white" : isDarkMode ? "bg-gray-800" : "bg-gray-100"}`, children: msg.content }) }, i)),
      researching && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rounded border p-3 text-xs ${isDarkMode ? "border-gray-700 bg-gray-900/50" : "border-gray-200 bg-gray-50"}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold", children: isLoading ? "Researching" : events.some((event) => event.type === "error") ? "Research failed" : "Research complete" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gray-500 mt-1", children: currentSource || `${sources.length} source${sources.length === 1 ? "" : "s"} inspected` }),
        sources.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 space-y-1", children: sources.map((source) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "truncate", children: [
          source.title,
          " ",
      ...
      events.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rounded border p-3 text-xs space-y-1 ${isDarkMode ? "border-gray-700 bg-gray-900/50" : "border-gray-200 bg-gray-50"}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold mb-2", children: "Execution trace" }),
        events.map((event, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex gap-2 items-start ${event.type === "error" ? "text-red-400" : "text-gray-400"}`, children: [
          icon(event.type),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: event.message })
        ] }, `${event.at}-${i}`))
      ] }),
      isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-gray-500", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Loader, { className: "animate-spin text-synapse-accent", size: 16 }),
        " Working through tools…"
      ] }),
      !isLoading && events.some((event) => event.type === "done") && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-green-500", children: "Run finished. Results are saved to run history." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: endRef })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `border-t ${isDarkMode ? "border-gray-700" : "border-gray-200"} p-4 flex gap-2`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: input, onChange: (e) => setInput(e.target.value), onKeyDown: (e) => e.key === "Enter" && run(), placeholder: "Ask AI to execute a task…", disabled: isLoading, className: `flex-1 px-3 py-2 rounded ${isDarkMode ? "bg-gray-700 text-white placeholder-gray-400" : "bg-gray-100 text-gray-900"} focus:outline-none focus:ring-2 focus:ring-synapse-accent` }),
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: cancel, className: "p-2 bg-red-600 text-white rounded", title: "Cancel", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Square, { size: 20 }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: run, disabled: !input.trim(), className: "p-2 bg-synapse-accent text-white rounded disabled:opacity-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { size: 20 }) })
    ] })
  ] });
}
...
const TabBar = ({
  ...
  const [hoveredTabId, setHoveredTabId] = reactExports.useState(null);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-12 flex items-center gap-1 px-2 bg-white/40 dark:bg-neutral-900/40 backdrop-blur-xl border-b border-white/20 dark:border-white/10 overflow-x-auto scrollbar-hide", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: tabs.map((tab) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.button,
        {
          ...
          className: `group flex items-center gap-2 px-3 py-1.5 rounded-lg min-w-max transition-all duration-200 ${isActive ? "bg-white/60 dark:bg-neutral-800/60 shadow-md" : "hover:bg-white/30 dark:hover:bg-neutral-800/30"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-4 h-4 flex-shrink-0", children: tab.isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-4 h-4 border-2 border-blue-400 border-t-transparent rounded-full animate-spin" }) : tab.favicon ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: tab.favicon, alt: "", className: "w-4 h-4 rounded" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-4 h-4 bg-gray-300 dark:bg-gray-600 rounded" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-gray-700 dark:text-gray-200 truncate max-w-xs", children: tab.title || "New Tab" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `flex-shrink-0 p-0.5 rounded hover:bg-red-500/20 transition-colors ${hoveredTabId === tab.id ? "opacity-100" : "opacity-0 group-hover:opacity-100"}`,
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 14, className: "text-gray-600 dark:text-gray-400 hover:text-red-500" })
              }
            )
          ]
        },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.button,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 16, className: "text-gray-600 dark:text-gray-400" })
      }
    )
  ] });
};
const BrowserView = ({ tabId }) => {
  const containerRef = reactExports.useRef(null);
  const [bounds, setBounds] = reactExports.useState({ x: 0, y: 0, width: 0, height: 0 });
  reactExports.useEffect(() => {
    ...
    const updateBounds = () => {
      ...
      if (newBounds.x !== bounds.x || newBounds.y !== bounds.y || newBounds.width !== bounds.width || newBounds.height !== bounds.height) {
        setBounds(newBounds);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: !tabId && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center text-gray-400", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No active tab" }) })
    }
  );
};
const MainLayout = ({ children }) => {
  ...
  const [isAIPanelOpen, setIsAIPanelOpen] = reactExports.useState(true);
  const [addressBarValue, setAddressBarValue] = reactExports.useState("");
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    const unsubscribe = window.electron.on("tabs-updated", (data) => {
      setTabs(data.tabs);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen w-screen overflow-hidden bg-gray-100 dark:bg-neutral-950", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "w-64 h-screen liquid-glass border-r border-glass-border flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex-1 px-2 py-4 space-y-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarItem, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { size: 18 }), label: "AI Workspace", active: true }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarItem, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 18 }), label: "Search" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarItem, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Files, { size: 18 }), label: "Explorer" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarItem, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Code, { size: 18 }), label: "Editor" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarItem, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Terminal, { size: 18 }), label: "Terminal" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-4 pb-2 px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider", children: "Personal" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarItem, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Bookmark, { size: 18 }), label: "Bookmarks" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarItem, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcwClock, { size: 18 }), label: "History" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 border-t border-glass-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarItem, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { size: 18 }), label: "Settings" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 flex flex-col overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "h-12 flex items-center gap-4 px-4 mac-toolbar", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: "mac-button hover:bg-black/5 dark:hover:bg-white/5",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCw, { size: 16 })
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleAddressBarSubmit, className: "flex-1 max-w-2xl relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-gray-400", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 14 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "mac-button hover:bg-black/5 dark:hover:bg-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 16 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "mac-button hover:bg-black/5 dark:hover:bg-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PanelsTopLeft, { size: 16 }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              className: `mac-button ${isAIPanelOpen ? "bg-blue-500 text-white" : "hover:bg-black/5 dark:hover:bg-white/5"}`,
              onClick: () => setIsAIPanelOpen(!isAIPanelOpen),
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { size: 16 })
            }
          )
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 relative overflow-hidden", children: children ? children : /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserView, { tabId: activeTabId }) })
    ] }),
    isAIPanelOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "w-96 h-screen border-l border-glass-border liquid-glass flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AIWorkspacePanel, {}) })
  ] });
};
const SidebarItem = ({ icon, label, active }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: `w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors ${active ? "bg-blue-500/10 text-blue-600 dark:text-blue-400 font-medium" : "text-gray-600 dark:text-gray-400 hover:bg-black/5 dark:hover:bg-white/5"}`, children: [
  icon,
...
const App = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(MainLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full w-full flex items-center justify-center bg-white dark:bg-neutral-900 text-gray-500", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold text-gray-900 dark:text-white mb-4", children: "Welcome to Synapse" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg", children: "Your AI-first developer workspace is ready." })
  ] }) }) });
};
